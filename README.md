...
Likewise, if you for whatever reason uninstalled the package or you just need to rebuild and reinstall it, all you have to do is delete the `lastlatest` file to make it do that.
